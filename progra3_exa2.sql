...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-02-2017 a las 23:26:02
...
(323, 987, 123, 'marienela', '2017-02-10', 2500),
(988, 0, 233, 'el gato negro', '2017-02-24', 3000);
...
--
ALTER TABLE `author`
  MODIFY `idAuthor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=457;
--
...
--
ALTER TABLE `book`
  MODIFY `idBook` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=989;
--
-- AUTO_INCREMENT de la tabla `booktype`
--
ALTER TABLE `booktype`
  MODIFY `idType` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=778;
